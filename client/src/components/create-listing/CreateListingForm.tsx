...
interface CreateListingFormProps {
  form: ReturnType<typeof useForm<CreateListingForm>>;
  onSubmit: (data: CreateListingForm) => void;
 ...
 * 
 * Displays the main form for creating a new listing with all
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Set your asking price for the asset
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <div className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Asset URL (Optional)</FormLabel>
                    <FormControl>
                      <Input placeholder="https://instagram.com/yourpage" {...field} />
                    </FormControl>
                    <FormDescription>
                      Link to your asset for verification purposes
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Asset Proof Screenshot</FormLabel>
                    <FormControl>
            ...
            {/* Metrics */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900">Metrics (Optional)</h3>
