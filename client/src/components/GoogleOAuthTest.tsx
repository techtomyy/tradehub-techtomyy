...
export function GoogleOAuthTest() {
  ...
  const { handleGoogleOAuth, validateAuthentication, checkAuthStatus } = useAuth();
  ...
  const testEnvironment = () => {
    ...
    if (!envVars.VITE_SUPABASE_URL || !envVars.VITE_SUPABASE_KEY) {
      toast({
        ...
        description: "Missing required Supabase environment variables. Please create a .env file with your Supabase credentials.",
        variant: "destructive",
  ...
  const testSupabaseConnection = async () => {
    try {
      ...
      toast({
        ...
        description: "Failed to test Supabase connection. Check your environment variables.",
        variant: "destructive",
        className: "bg-red-50 border-red-200 text-red-800",
      });
    } finally {
  ...
  const testCurrentAuthStatus = () => {
    ...
    if (currentStatus) {
      toast({
        title: "✅ Auth Status Check Passed",
        description: "User is currently authenticated",
        className: "bg-green-50 border-green-200 text-green-800",
      });
    } else {
      toast({
        title: "❌ Auth Status Check Failed",
    ...
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <p className="text-sm text-gray-600">
          Use this tool to test and debug authentication configuration
        </p>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-sm text-gray-600 space-y-2">
          ...
          <ol className="list-decimal list-inside space-y-1">
            ...
            <li>Test OAuth - Check Google OAuth flow</li>
            <li>Test Auth - Validate authentication state</li>
            <li>Check Current Status - See current authentication state</li>
          </ol>
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded">
            <p className="text-blue-800 text-sm">
              ...
              with your Supabase credentials from the <code>env.template</code> file.
            </p>
          </div>
        </div>
      </CardContent>
